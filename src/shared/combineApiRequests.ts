...
/**
 * Combines API request start and finish messages in an array of CodeaMessages.
 *
 ...
 * @returns A new array of CodeaMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: CodeaMessage[]): CodeaMessage[] {
	const combinedApiRequests: CodeaMessage[] = []
