import { CodeaMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of CodeaMessages.
 *
 * This function processes an array of CodeaMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of CodeaMessage objects to process.
 * @returns A new array of CodeaMessage objects with command sequences combined.
 *
 * @example
 * const messages: CodeaMessage[] = [
 ...
 */
export function combineCommandSequences(messages: CodeaMessage[]): CodeaMessage[] {
	const combinedCommands: CodeaMessage[] = []
